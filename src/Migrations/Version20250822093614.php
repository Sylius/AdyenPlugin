...
final class Version20250822093614 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE sylius_adyen_payment_link (id INT AUTO_INCREMENT NOT NULL, payment_id INT DEFAULT NULL, payment_link_id VARCHAR(64) NOT NULL, payment_link_url VARCHAR(1000) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_36C97E03B4ED0C9B (payment_link_id), INDEX IDX_36C97E034C3A3BB (payment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
