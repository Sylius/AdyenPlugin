...
final class AddOrderPaymentWorkflowTransitionPass implements CompilerPassInterface
{
    ...
    {
        if (!$container->hasDefinition('state_machine.sylius_order_payment.definition')) {
            return;
        }

        $definition = $container->getDefinition('state_machine.sylius_order_payment.definition');
